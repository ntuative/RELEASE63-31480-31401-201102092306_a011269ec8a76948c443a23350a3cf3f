package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1620 || param2 != this.var_1621)
         {
      ...
      {
         if(this.var_1309 > 255 || bitmapData == null)
         {
            return false;
         }
