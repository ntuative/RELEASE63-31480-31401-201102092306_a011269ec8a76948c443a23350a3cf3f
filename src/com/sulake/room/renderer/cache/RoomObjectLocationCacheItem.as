package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1660 || param1.getUpdateID() != this.var_2501)
         {
            this.var_2501 = param1.getUpdateID();
            if(param2.updateId != this.var_1660 || _loc4_.x != this.var_1148.x || _loc4_.y != this.var_1148.y || _loc4_.z != this.var_1148.z)
            {
               this.var_1660 = param2.updateId;
               this.var_1148.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2500 = _loc3_;
         if(_loc3_)
         {
