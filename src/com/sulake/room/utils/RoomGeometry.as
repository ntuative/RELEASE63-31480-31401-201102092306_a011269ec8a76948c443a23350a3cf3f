package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_816:Number = 64;
      ...
      private var var_2774:Number = -500.0;
      
      private var var_2773:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1895 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_166.x,this.var_166.y,this.var_166.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_77.x * this.var_429,this.var_77.y * this.var_428,this.var_77.z * this.var_430);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_264.x,this.var_264.y,this.var_264.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_429 != param1 * this.var_1896)
         {
            this.var_429 = param1 * this.var_1896;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_428 != param1 * this.var_1894)
         {
            this.var_428 = param1 * this.var_1894;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_430 != param1 * this.var_1895)
         {
            this.var_430 = param1 * this.var_1895;
            ++this.var_159;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_77.x;
         var _loc3_:Number = this.var_77.y;
         var _loc4_:Number = this.var_77.z;
         this.var_77.assign(param1);
         this.var_77.x /= this.var_429;
         this.var_77.y /= this.var_428;
         this.var_77.z /= this.var_430;
         if(this.var_77.x != _loc2_ || this.var_77.y != _loc3_ || this.var_77.z != _loc4_)
         {
            ++this.var_159;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_264.x;
         var _loc3_:Number = this.var_264.y;
         var _loc4_:Number = this.var_264.z;
         this.var_264.assign(param1);
         if(this.var_264.x != _loc2_ || this.var_264.y != _loc3_ || this.var_264.z != _loc4_)
         {
            ++this.var_159;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1204.assign(_loc22_);
         }
         else
         {
            this.var_1204.assign(_loc17_);
         }
         ++this.var_159;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_77);
         _loc2_.x *= this.var_429;
         _loc2_.y *= this.var_428;
         _loc2_.z *= this.var_430;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1204);
         if(_loc3_ < this.var_2774 || _loc3_ > this.var_2773)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_77);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_429;
            _loc2_.y *= this.var_428;
            _loc2_.z *= this.var_430;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1204);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_77.x * this.var_429,this.var_77.y * this.var_428,this.var_77.z * this.var_430);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_166;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_429,param2.y * this.var_428,param2.z * this.var_430);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_429,param3.y * this.var_428,param3.z * this.var_430);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_429,param4.y * this.var_428,param4.z * this.var_430);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_816;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_816;
      }
