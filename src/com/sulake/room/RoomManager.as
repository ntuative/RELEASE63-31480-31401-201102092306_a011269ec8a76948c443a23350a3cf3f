package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2783:IRoomContentLoader;
      
      private var var_545:IRoomObjectFactory = null;
      
      private var var_451:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1007:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_858,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_545 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_545 == null || this.var_451 == null)
         {
            return;
         }
         this._state = const_1436;
         if(this.var_1007 != null)
         {
            _loc1_ = this.var_1007;
            this.var_1007 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_546.indexOf(_loc5_) < 0)
            {
               this.var_48.loadObjectContent(_loc5_,events);
               this.var_546.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_547.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_547[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_545.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_545 != null)
         {
            return this.var_545.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_48.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_546.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_48 == null || this.var_451 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_545.createRoomObjectLogic(_loc18_);
