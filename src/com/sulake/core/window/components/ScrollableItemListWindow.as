package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_389:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_79))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_389)
         {
            this.var_389.removeEventListener(WindowEvent.const_297,this.scrollBarEventProc);
            this.var_389.removeEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            this.var_389 = null;
         }
         if(this.var_1025)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_389)
         {
            this.var_389 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_389)
            {
               this.var_389.addEventListener(WindowEvent.const_297,this.scrollBarEventProc);
               this.var_389.addEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            }
         }
         return this.var_389;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_254)
         {
            this.hideScrollBar();
         }
      }
