package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1329:String = "increment";
      
      private static const const_1330:String = "decrement";
      
      private static const const_944:String = "slider_track";
      
      private static const const_592:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_645:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_162 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_533;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_20 != null && !this.var_20.disposed)
         {
            ...
            this.var_20.removeEventListener(WindowEvent.const_503,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_45,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_503,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_944) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_592) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_592:
         ...
         if(param2.type == WindowNotifyEvent.const_569)
         {
            if(this.var_20 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_295)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_645;
                  }
                  else
                  {
                     this.scrollV -= this.var_645;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_576)
         {
            ...
            else if(param2.name == const_1330)
            {
               if(this.var_20)
               {
                  this.var_1161 = true;
            ...
            else if(param2.name == const_944)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_592).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_295)
         {
