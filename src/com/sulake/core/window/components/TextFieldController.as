package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1225 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_576)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_694 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_358,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_694,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1454);
         _loc1_.push(this.var_1232 != PropertyDefaults.const_1099 ? new PropertyStruct(PropertyDefaults.const_658,this.var_1232,PropertyStruct.const_37,true) : PropertyDefaults.const_1471);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1199 ? new PropertyStruct(PropertyDefaults.const_726,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1378);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1117 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1361);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_694:
                  ...
                  break;
               case PropertyDefaults.const_1104:
