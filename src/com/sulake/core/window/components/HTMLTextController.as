package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_902:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1691:StyleSheet = null;
      ...
      {
         this.var_721 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1107 == param2)
         {
            return;
         }
         param1.var_1107 = param2;
         param1.var_1691 = null;
         if(param1.var_1107 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1107);
            param1.var_1691 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_823.indexOf(param1) > -1)
         {
            this.var_721 = param1;
         }
      }
      ...
      {
         return this.var_721 == LinkTarget.const_31 ? defaultLinkTarget : this.var_721;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1691;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_721 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_772,this.var_721,PropertyStruct.const_49,true,PropertyDefaults.const_823));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1609);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_721 = _loc2_.value as String;
               break;
            }
