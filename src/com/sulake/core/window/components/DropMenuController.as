package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_233.lenght - 1)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_165 == null || this.var_165.disposed)
         {
            this.var_165 = context.create(name + "::submenu","",WindowType.const_468,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_233.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_830 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_830)
         {
            if(this.open())
            {
               if(this.var_233.length)
               {
                  this.populateMenuItemContainer(this.var_233,this.getSubMenu(),this.subMenuEventProc);
                  this.var_830 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_830 = false;
            this.getTitleLabel().text = this.var_554 < this.var_233.length && this.var_554 > -1 ? this.var_233[this.var_554] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_539,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_350,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_554 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_554).setStateFlag(WindowState.const_50,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_576)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1033:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_717:
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_233[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_233.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_655,this.var_233,PropertyStruct.const_130,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1435);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_655)
            {
