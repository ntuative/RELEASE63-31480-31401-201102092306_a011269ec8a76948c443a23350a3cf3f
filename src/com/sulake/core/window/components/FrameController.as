package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1280:String = "_TITLE";
      
      private static const const_1327:String = "_HEADER";
      
      private static const const_1325:String = "_CONTENT";
      
      private static const const_1326:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1404:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1280) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1404 = findChildByTag(const_1327) as IHeaderWindow;
            if(!this.var_1404)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_173 = findChildByTag(const_1325) as IWindowContainer;
            if(!this.var_173)
            {
      ...
      {
         return findChildByTag(const_1326) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_989 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_317);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_262);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_277,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_211,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_239,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
