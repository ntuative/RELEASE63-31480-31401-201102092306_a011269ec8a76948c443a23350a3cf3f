package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1333:String = "_SELECTOR";
      ...
      protected var var_1980:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_991 = findChildByTag(const_1333) as ITabSelectorWindow;
            if(this.var_991 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1980 = findChildByTag(const_1332) as IWindowContainer;
         }
      ...
      {
         return !!this.var_694 ? this.selector.iterator : null;
      }
