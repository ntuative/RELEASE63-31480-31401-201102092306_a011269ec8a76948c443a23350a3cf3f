package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1983:Boolean = false;
      ...
      protected var var_992:Boolean = true;
      
      protected var var_441:Boolean = false;
      
      protected var var_1233:Boolean = false;
      
      protected var var_1981:int = 0;
      
      protected var var_1982:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_162 = var_439 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_350,WindowStyle.const_605,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_45,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_457,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_285,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_454,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1233;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_646)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_503,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_445,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_457,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_285,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_454,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_190:
               if(this.var_1235)
               {
                  this.var_1234 = this.var_1981 - _loc3_;
                  this.var_1236 = this.var_1982 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1234 != 0 && this.var_101 != 0)
                     {
                        this.scrollH += this.var_1234 / this.var_101;
                     }
                  }
                  else if(this.var_1236 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1236 / this.var_91;
                  }
                  this.var_1981 = _loc3_;
                  this.var_1982 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_170:
               if(this.var_1235)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1234,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1236);
                  }
                  this.var_1235 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_992 && !this.var_530 && this._container)
         {
            this.var_530 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_607)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_383,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1097);
         }
         if(this.var_992 != PropertyDefaults.const_1159)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_736,this.var_992,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1375);
         }
         if(this.var_441 != PropertyDefaults.const_1020)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_876,this.var_441,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1640);
         }
         if(this.var_1233 != PropertyDefaults.const_1191)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_856,this.var_1233,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1360);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_736:
                  this.var_992 = _loc2_.value as Boolean;
                  break;
            }
         }
