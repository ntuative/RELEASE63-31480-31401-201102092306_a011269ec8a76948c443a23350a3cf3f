package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1210:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_398,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_398 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_398,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_859 ? true : null;
         }
      ...
      {
         this.var_796 = param1;
         this._field.scrollH = this.var_796 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_796 * this.maxScrollH,this.var_525 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1068) ? new PropertyStruct(PropertyDefaults.const_891,this._field.antiAliasType,PropertyStruct.const_49,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1140) : PropertyDefaults.const_1509);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1152 ? new PropertyStruct(PropertyDefaults.const_793,this._autoSize,PropertyStruct.const_49,true,PropertyDefaults.const_1131) : PropertyDefaults.const_1403);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_227,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1163 ? new PropertyStruct(PropertyDefaults.const_1179,this._field.gridFitType,PropertyStruct.const_49,true,PropertyDefaults.const_1122) : PropertyDefaults.const_1446);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_698) ? new PropertyStruct(PropertyDefaults.const_373,this._field.textColor,PropertyStruct.const_127,true) : PropertyDefaults.const_1045);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_691 ? new PropertyStruct(PropertyDefaults.const_211,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_438);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_769 ? new PropertyStruct(PropertyDefaults.const_257,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_524);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_735 ? new PropertyStruct(PropertyDefaults.const_215,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_527);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_796 ? new PropertyStruct(PropertyDefaults.const_239,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_427);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1017 ? new PropertyStruct(PropertyDefaults.const_705,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1597);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_266,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_266,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_266,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
