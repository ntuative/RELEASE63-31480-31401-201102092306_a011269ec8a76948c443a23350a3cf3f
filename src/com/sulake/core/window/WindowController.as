package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1197:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1211:String = "_COLORIZE";
      
      protected static const const_1661:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1456:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_771 = _loc13_.blend;
            var_440 = _loc13_.var_2717;
            if(var_439 != _loc13_.background)
            {
      ...
      {
         var_439 = param1;
         var_228 = !!var_439 ? uint(var_228 | var_529) : uint(var_228 & 16777215);
      ...
      {
         var_799 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_461,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_529 = param1 & 4278190080;
         var_228 = !!var_439 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_66);
      }
      ...
      {
         var_529 = param1 << 24;
         var_228 = !!var_439 ? uint(var_529 | var_228) : uint(16777215 & var_228);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_66);
      }
      
      public function set blend(param1:Number) : void
      {
         var_771 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1064);
      }
      ...
      {
         var_440 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            else
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1155,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_671,var_11);
            this.var_21.visible = var_375;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_18,var_16,var_11,null,this.var_649,this.properties,var_800.concat(),_id) as WindowController;
         _loc2_.var_440 = var_440;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2662 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_441)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_418)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1113,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_851,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_575,this,null));
            }
            if(_loc6_)
            {
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_820))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1184;
                  if(testParamFlag(WindowParam.const_395))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_317))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_168:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_466,this,null));
                     if(testParamFlag(WindowParam.const_174,WindowParam.const_162))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_183,WindowParam.const_153))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_445))
                        {
               ...
               case WindowNotifyEvent.const_575:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_551);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1018,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_389:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_830,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_237,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_434:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1044);
                  break;
               case WindowNotifyEvent.const_439:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1661) == -1)
                     {
                        _loc8_.style = var_79;
                     }
                  }
               ...
               case WindowNotifyEvent.const_461:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_551);
                     }
                  }
                  else if(var_18 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1185:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1554:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1482:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1151:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1195:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_440);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_440);
      }
         ...
         if(this.var_162 && var_440 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1456,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1456,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_162);
         var _loc2_:* = !testParamFlag(WindowParam.const_145,WindowParam.const_153);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_389;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_71,true);
         _loc1_.type = WindowNotifyEvent.const_1105;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         if(!this.getStateFlag(WindowState.const_79))
         {
            return true;
         }
         ...
         this.setStateFlag(WindowState.const_79,false);
      ...
      public function disable() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_79,true);
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_337,this,param1));
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_884,this,param1));
         return param1;
      }
