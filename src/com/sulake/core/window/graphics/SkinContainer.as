package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_950:uint = 8;
      
      private static const const_1340:String = "skin";
      
      private static const const_1338:String = "bitmap";
      
      private static const const_1342:String = "fill";
      
      private static const const_1343:String = "text";
      
      private static const const_1339:String = "label";
      
      private static const const_1341:String = "shape";
      ...
      private var var_1824:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1824 = new Dictionary();
         this.var_2575 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1824,this.var_2575);
         this.var_2574 = new Dictionary();
         this.var_2576 = new Dictionary();
         StateCodeTable.fillTables(this.var_2574,this.var_2576);
         this.var_419 = new Dictionary();
         this.var_419[const_1340] = BitmapSkinRenderer;
         this.var_419[const_1338] = BitmapDataRenderer;
         this.var_419[const_1342] = FillSkinRenderer;
         this.var_419[const_1343] = TextSkinRenderer;
         this.var_419[const_1339] = LabelRenderer;
         this.var_419[const_1341] = ShapeSkinRenderer;
         this.var_419[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_419[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_312 == null)
         {
            var_312 = new Array();
            var_312.push(WindowState.const_71);
            var_312.push(WindowState.const_79);
            var_312.push(WindowState.const_84);
            var_312.push(WindowState.const_50);
            var_312.push(WindowState.const_88);
            var_312.push(WindowState.const_82);
            var_312.push(WindowState.const_101);
            var_312.push(WindowState.const_92);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1824[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_942[param1] == null)
         {
            this.var_942[param1] = new Array(const_950);
         }
         this.var_942[param1][param2] = param3;
         if(this.var_941[param1] == null)
         {
            this.var_941[param1] = new Array(const_950);
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_942[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_186)
            {
               _loc4_ = _loc3_["null"];
            }
         }
