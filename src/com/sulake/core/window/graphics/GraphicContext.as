package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_671:uint = 1;
      
      public static const const_1188:uint = 2;
      
      public static const const_632:uint = 4;
      
      public static const const_1505:uint = 8;
      
      public static const const_1514:uint = 16;
      
      public static const const_1764:uint = 64;
      
      public static const const_1816:uint = 128;
      
      public static const const_1207:uint = 256;
      
      protected static var var_532:uint = 0;
      
      protected static var var_311:uint = 0;
         ...
         if(this.var_797)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_311 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1976,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1976,16777215);
                  }
                  var_311 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_797)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_311 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
