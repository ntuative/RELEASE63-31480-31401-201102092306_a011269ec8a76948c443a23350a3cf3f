package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_600:uint = 0;
      ...
      private var var_1912:ColorTransform;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1467 = 4294967295;
         this.var_978 = 0;
         this.var_1912 = new ColorTransform();
         this.var_986 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_962) : uint(const_600);
         var _loc6_:Boolean = this.var_182.width > 0 && this.var_182.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_978))
            {
               _loc5_ = const_963;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_963)
               {
                  ...
                  if(this.var_637)
                  {
                     ...
                     _loc7_.draw(param1,this.var_100,this.var_100.rect,this.var_978,false);
                  ...
                  {
                     this.var_986.tx = param2.x;
                     this.var_986.ty = param2.y;
                     this.var_1912.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_100,this.var_986,this.var_1912,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_825.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_186)
            {
               _loc2_ = this.var_825.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_186);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_825.getTheActualState(param1.type,param1.style,param1.state) != this.var_1467;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_551:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1044:
               this.var_978 = this.var_825.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_978 != this.var_1467)
               {
                  this.var_637 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1064:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_637 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1084:
               _loc4_ = true;
         }
         if(_loc4_)
         {
