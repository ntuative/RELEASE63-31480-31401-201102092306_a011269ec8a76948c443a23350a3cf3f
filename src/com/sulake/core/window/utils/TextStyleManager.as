package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_512:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_598:String = "{";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_176],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_176] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_512.indexOf(_loc4_.name) == -1)
            {
               var_512.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_599);
         if(countSubStrings(param1,const_598) != countSubStrings(param1,const_599))
         {
            throw new Error("Mismatching amount of \"" + const_598 + "\" versus \"" + const_599 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_598)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
