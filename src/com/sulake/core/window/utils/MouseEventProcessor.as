package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_134 = param1.desktop;
         this.var_80 = param1.var_1215 as WindowController;
         this._lastClickTarget = param1.var_1214 as WindowController;
         this.var_151 = param1.renderer;
         this.var_801 = param1.var_1217;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_648.x || _loc3_.stageY != this.var_648.y)
            {
               ...
               _loc6_ = new Array();
               this.var_134.groupParameterFilteredChildrenUnderPoint(this.var_648,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_80 != this.var_134 && !this.var_80.disposed)
                  {
                     ...
                     this.var_80 = WindowController(this.var_134);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_80 && !this.var_80.disposed)
                     {
                        ...
                        {
                           this.var_801.mouseEventReceived(_loc3_.type,this.var_80);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_134;
         param1.var_1215 = this.var_80;
         param1.var_1214 = this._lastClickTarget;
         param1.renderer = this.var_151;
         param1.var_1217 = this.var_801;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testStateFlag(WindowState.const_79))
         {
            return null;
         }
         ...
         if(param1.testParamFlag(WindowParam.const_478))
         {
