package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_994:String = "_EXCLUDE";
      
      public static const const_1891:String = "_INCLUDE";
      
      public static const const_1784:String = "_TEMP";
      
      private static const const_1227:String = "layout";
      
      private static const const_896:String = "window";
      
      private static const const_897:String = "variables";
      
      private static const const_898:String = "filters";
      
      private static const const_578:String = "name";
      
      private static const const_1212:String = "style";
      
      private static const const_580:String = "params";
      
      private static const const_1216:String = "tags";
      ...
      private static const const_1224:String = "visible";
      
      private static const const_1221:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1064:String = "blend";
      
      private static const const_1213:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1215:String = "treshold";
      
      private static const const_1214:String = "children";
      
      private static const const_1223:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1217:String = "height_min";
      
      private static const const_1222:String = "height_max";
      
      private static const const_579:String = "true";
      
      private static const const_154:String = "0";
      
      private static const const_1220:String = "$";
      
      private static const const_1219:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1225:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1218:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1219:Dictionary;
      
      protected var var_1218:Dictionary;
      
      protected var var_982:Dictionary;
      
      protected var var_1475:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1219,this.var_1218);
         this.var_982 = new Dictionary();
         this.var_1475 = new Dictionary();
         ParamCodeTable.fillTables(this.var_982,this.var_1475);
         this.var_1961 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1218,const_48);
         return param1.replace(const_1225,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1219)
            {
               delete this.var_1219[_loc1_];
            }
            for(_loc1_ in this.var_1218)
            {
               delete this.var_1218[_loc1_];
            }
            for(_loc1_ in this.var_982)
            {
               delete this.var_982[_loc1_];
            }
            for(_loc1_ in this.var_1475)
            {
               delete this.var_1475[_loc1_];
            }
            this.var_1961.dispose();
            this.var_1961 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1227)
         {
            _loc8_ = param1.child(const_897);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_898).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1219[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_578,variables,"")));
         style = uint(this.parseAttribute(xml,const_1212,variables,style));
         params = uint(this.parseAttribute(xml,const_580,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1216,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_154));
         rect.y = Number(this.parseAttribute(xml,const_907,variables,const_154));
         rect.width = Number(this.parseAttribute(xml,const_1226,variables,const_154));
         rect.height = Number(this.parseAttribute(xml,HEIGHT,variables,const_154));
         visible = this.parseAttribute(xml,const_1224,variables,visible.toString()) == const_579;
         caption = unescape(String(this.parseAttribute(xml,const_1221,variables,caption)));
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_580).length() > 0)
         {
            list = xml.child(const_580).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_578,variables,"") as String;
               if(this.var_982[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_578)) + "\"!");
               }
               params |= this.var_982[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1219);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_897)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1223,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1217,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1222,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_579;
         blend = Number(this.parseAttribute(xml,const_1064,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1213,variables,window.clipping.toString()) == const_579;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1215,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_898).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_994) == -1)
                  {
