package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1025:String = "AssetLibraryReady";
      
      public static const const_702:String = "AssetLibraryLoaded";
      
      public static const const_1510:String = "AssetLibraryUnloaded";
      
      public static const const_1455:String = "AssetLibraryLoadError";
      
      private static var var_272:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_444:uint = 0;
      
      private static var var_804:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_444;
         this.var_377 = new Dictionary(false);
         this.var_443 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_804.splice(var_804.indexOf(this),1);
            --var_444;
            this.var_443 = null;
            this.var_805 = null;
            this.var_138 = null;
      ...
      {
         if(this._file == param1.url && this.var_806)
         {
            if(!this.var_807 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_650,this.var_534);
            }
            this.var_807 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1025));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_443)
         {
            _loc2_ = this.var_443[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_443[_loc1_];
         }
         ...
         this.var_806 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1510));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_805[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_443[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1093,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1070,this.assetLoadEventHandler);
         ...
         this.var_443[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_443[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_379;
                     this.var_378.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_443[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_378.length ? this.getAssetByName(this.var_378[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_138)
         {
            ...
            {
               return this.var_378.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_138[param1] != null || (this.var_534 != null ? this.var_534[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_377.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_377[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_377[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_377)
         {
            _loc3_ = AssetTypeDeclaration(this.var_377[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_377)
         {
            _loc4_ = AssetTypeDeclaration(this.var_377[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_650 = _loc2_.manifest.copy();
         ...
         this.var_806 = true;
         dispatchEvent(new Event(AssetLibrary.const_702));
         dispatchEvent(new Event(AssetLibrary.const_1025));
         if(this.var_807)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1455));
         this.var_40 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_650.child("library");
         if(_loc2_ == null)
         {
