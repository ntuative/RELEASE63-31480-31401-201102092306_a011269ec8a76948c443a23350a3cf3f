package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      {
         var _loc1_:* = null;
         if(this.var_115 is Class)
         {
            _loc1_ = new this.var_115() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_115() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_115 = null;
               return;
         ...
         if(this.var_115 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_115).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_115 is BitmapData)
         {
            this._bitmap = this.var_115 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_115 = null;
               return;
         ...
         if(this.var_115 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_115)._bitmap;
            this._offset = BitmapDataAsset(this.var_115)._offset;
            this.var_1428 = BitmapDataAsset(this.var_115).var_1428;
            this.var_1429 = BitmapDataAsset(this.var_115).var_1429;
            if(this._bitmap != null)
            {
               this.var_115 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1428 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1429 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
