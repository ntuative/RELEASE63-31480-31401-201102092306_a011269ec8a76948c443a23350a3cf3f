package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1657:uint = 1;
      
      protected static const const_1658:uint = 2;
      ...
      public static const const_1103:Boolean = false;
      
      public static const const_1420:int = 2;
      
      private static var var_867:Array = new Array();
      
      private static var var_703:Array = new Array();
      ...
      protected var var_227:URLRequest;
      
      protected var var_650:XML;
      ...
      protected var var_988:Boolean = false;
      ...
      protected var var_2808:uint = 0;
      
      protected var var_2729:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_40.load(param1.var_227,param1.var_16);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1103)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_703[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_703.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_703.length < const_1420 && false)
            {
               _loc1_ = var_867.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_703.push(_loc1_);
                  _loc1_.var_40.load(_loc1_.var_227,_loc1_.var_16);
               }
            }
         }
      }
      ...
      {
         return !!this.var_227 ? this.var_227.url : null;
      }
      ...
      {
         return !!this.var_989 ? uint(this.var_1224 - this.var_1970) : uint(getTimer() - this.var_1970);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_227.url);
      ...
      {
         if(this.var_988 && !_disposed)
         {
            this.var_988 = false;
            if(!this.var_989 && this.var_227)
            {
               this.var_1224 = -1;
               this.var_1970 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_989 && !_disposed && this.var_1223 > 0)
         {
            try
            {
               this.var_40.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_227,const_1557 - this.var_1223);
            if(this.var_2729)
            {
               this.var_227.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_227.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2729 = false;
            }
            --this.var_1223;
            this.var_436 = 0;
            this.var_40.load(this.var_227,this.var_16);
            return true;
         }
         return false;
      }
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         if(this.var_534 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_227.url + "!");
            }
            return false;
         }
         try
         ...
         try
         {
            this.var_650 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
