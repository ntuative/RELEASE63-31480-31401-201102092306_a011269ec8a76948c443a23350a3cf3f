package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1420:int = 4;
      ...
      {
         return this.var_387.length + this.var_268.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_268.length < const_1420 && this.var_387.length > 0)
            {
               _loc1_ = this.var_387.shift();
               this.var_268.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            ...
            index = this.var_268.indexOf(loader);
            if(index > -1)
            {
               this.var_268.splice(index,1);
            }
         }
         catch(e:Error)
         {
