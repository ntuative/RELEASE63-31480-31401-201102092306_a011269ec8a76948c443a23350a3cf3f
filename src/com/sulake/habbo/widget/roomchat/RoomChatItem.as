package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_934:Number = 18;
      
      private static const const_590:int = 6;
      
      private static const const_1288:int = 6;
      
      private static const const_933:int = 35;
      
      private static var var_339:IRegionWindow;
      
      private static var var_407:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_407)
         {
            var_407 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
            var_407.tags.push("roomchat_bubble");
            var_407.x = 0;
            var_407.y = 0;
            var_407.width = 0;
            var_407.background = true;
            var_407.mouseThreshold = 0;
            var_212.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_406)
         {
         ...
         if(!var_339)
         {
            var_339 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_339.tags.push("roomchat_bubble");
            var_339.x = 0;
            var_339.y = 0;
            var_339.width = 0;
            var_339.background = true;
            var_339.mouseThreshold = 0;
            var_212.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
      }
      ...
      {
         this.var_1375 = param1.chatType;
         this.var_1118 = param1.userId;
         this.var_912 = param1.userName;
         this.var_1119 = param1.userCategory;
         this._message = param1.text;
         this.var_480 = param1.links;
         this.var_1713 = param1.userX;
         this.var_245 = param1.userImage;
         this.var_2451 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_167,this.width,const_934);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1375)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_115:
               this._window = var_407.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_287:
               this._window = var_339.clone() as IRegionWindow;
               isRespect = true;
               break;
         ...
         if(this.var_245 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_727 = Math.max(0,(this.var_245.height - background.height) / 2);
         ...
         if(this.var_1375 == RoomWidgetChatUpdateEvent.const_287)
         {
            textWindow.text = this._localizations.registerParameter("widgets.chatbubble.respect","username",this.var_912);
            this._width = const_933;
         }
         else if(this.var_1375 == RoomWidgetChatUpdateEvent.const_299)
         {
            textWindow.text = this._localizations.registerParameter("widget.chatbubble.petrespect","petname",this.var_912);
            this._width = const_933;
         }
         else if(this.var_480 == null)
         {
         ...
         else
         {
            ...
            lastLinkEndPos = -1;
            i = 0;
            while(i < this.var_480.length)
            {
               filteredLink = this.var_480[i][1];
               placeHolder = "{" + i + "}";
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.width = messageWidth + const_1288;
         ...
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2451,isRespect);
      ...
      private function onMessageLinkMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_728.length)
         {
            if(_loc2_ >= this.var_728[_loc3_][0] && _loc2_ <= this.var_728[_loc3_][1])
            {
               if(this.var_480[_loc3_][2] == 0)
               {
                  HabboWebTools.openExternalLinkWarning(this.var_480[_loc3_][0]);
               }
               else if(this.var_480[_loc3_][2] == 1)
               {
                  HabboWebTools.openWebPage(this.var_1711 + this.var_480[_loc3_][0],"habboMain");
               }
               else
               {
                  HabboWebTools.openWebPage(this.var_1711 + this.var_480[_loc3_][0]);
               }
            }
            _loc3_++;
         }
      ...
      {
         this._widget.onItemMouseClick(this.var_1118,this.var_912,this.var_1119,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1118,this.var_1119,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1118,this.var_1119,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1118,this.var_1119,this._roomId,this._roomCategory,param1);
      }
