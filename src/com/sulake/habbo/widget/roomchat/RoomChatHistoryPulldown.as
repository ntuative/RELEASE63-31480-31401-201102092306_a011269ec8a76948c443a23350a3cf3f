package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_921:int = 150;
      
      private static const const_920:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_38 = param3;
         this.var_2336 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1665 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2337 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1664 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1663 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2340 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2339 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_71 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_273,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_38.addChild(this.var_71);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_38.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_38.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_737,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_447:
               this.var_71.blend += param1 / const_920;
               this._window.blend += param1 / const_920;
               ...
               break;
            case const_958:
               this.var_71.blend -= param1 / const_921;
               this._window.blend -= param1 / const_921;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_38.width - this.var_2341;
         }
         if(this.var_71 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2338 == this._window.width)
         {
            return;
         }
         this.var_2338 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2337;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1664;
            _loc2_.disposesBitmap = false;
            this.var_2341 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2336,_loc7_);
         ...
         this.var_71.bitmap = this.var_2339;
