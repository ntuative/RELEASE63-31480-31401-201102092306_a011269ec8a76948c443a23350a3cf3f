package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1238,const_1239,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1415 = _loc2_.light;
         if(this.var_416 != null)
         {
            this.var_416.setValue(this.var_1415);
         }
         this.var_499 = this.colors.indexOf(_loc2_.color);
         if(this.var_620 != null)
         {
            this.var_620.setSelectedColorIndex(this.var_499);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1414 = XML(_loc1_.content);
         return this.var_1414;
      }
