package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_696,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_716,this.onSettings);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_707,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_716,this.onSettings);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_248,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_707,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_983:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1561:
         }
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         this.var_2064 = param1.allowPaste;
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_643,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_706 = this.var_706 - 1;
            this._visualization.showFloodBlocking(this.var_706);
         }
      }
      ...
      {
         this.var_1327 = true;
         this.var_706 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_706 + " seconds");
         if(this.var_707)
         {
            this.var_707.reset();
         }
         ...
         {
            this.var_707 = new Timer(1000,this.var_706);
            this.var_707.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_707.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_707.start();
         if(this._visualization != null)
         {
