package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_153:IFrameWindow;
      
      private var var_618:IWindow;
      ...
      private const const_943:int = 5;
      
      private const const_1700:int = 39;
      
      private const const_1701:int = 7829367;
      
      private const const_1702:int = 16777215;
      
      private const const_1973:int = 2000;
      ...
      {
         if(this.var_51 == null || this.var_220 == null || this.var_64 == null)
         {
            return;
         }
         this.var_64.width = this.var_64.scrollableRegion.width;
         this.var_51.height = this.var_51.scrollableRegion.height;
         this.var_220.height = this.var_51.height + 20;
         this._window.width = Math.max(this.var_220.width,this.var_64.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_220.width < this.var_64.width)
         {
            this.var_220.x = this._window.width - this.var_220.width;
            this.var_64.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_220 = this._window.getListItemByName("info_border") as IBorderWindow;
         ...
         {
            this.var_51 = this.var_220.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_220.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_220.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_220.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_220.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_943;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_943;
         if(param2)
         {
      ...
      protected function method_9(param1:String, param2:String) : void
      {
         var _loc3_:IRegionWindow = this.var_64.getListItemByName(param1) as IRegionWindow;
         if(_loc3_ != null)
         {
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_169:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_248:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_1015:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1047:
               _loc2_ = "${infostand.button.trade.tooltip.tradingroom}";
               break;
            default:
               _loc2_ = "";
         }
         this.method_9("trade",_loc2_);
      }
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2543 > this.const_1973 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2543 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1701;
            if(_loc3_.length >= this.const_1700)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1700 - 1);
            }
         }
      }
      ...
      {
         this.var_153 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_153.center();
         this.var_153.procedure = this.badgesEventProc;
         this.var_153.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_153 && this.var_153.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_618 = null;
         var _loc2_:IItemGridWindow = this.var_153.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_153.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_153.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_618);
               }
               if(_loc3_ <= -1)
               {
                  return;
