package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1157:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1158 = 0;
         this.var_1157 = param2.rectangle.clone();
         this.var_1157.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1157.width)
         {
            return false;
         }
         if(this.var_1158 + param1.height > this.var_1157.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1157.width)
         {
            this._offsetX = 0;
            this.var_1158 += param1.height + this.const_1975;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1158);
      ...
      {
         var _loc2_:* = null;
         if(this.var_1406 != null && this.var_1406.indexOf(param1) != -1)
         {
