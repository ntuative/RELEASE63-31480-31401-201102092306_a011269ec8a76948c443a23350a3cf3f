package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1987:int = 158;
      
      private const const_1986:int = 16;
      
      private const const_1989:uint = 11184810;
      
      private const const_1990:uint = 6710886;
      
      private const const_1983:uint = 3355443;
      
      private const const_1988:String = "level";
      
      private const const_1991:String = "experience";
      
      private const const_1984:String = "energy";
      
      private const const_1985:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1988,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1991,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1984,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1985,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1450.remove(param1.id);
         this.var_1450.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1987,this.const_1986,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1989);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1983);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1990);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1450.getValue(this.var_454) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = this.var_220.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_220.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_197 && this.var_197.getPetId() == this.var_454)
               {
