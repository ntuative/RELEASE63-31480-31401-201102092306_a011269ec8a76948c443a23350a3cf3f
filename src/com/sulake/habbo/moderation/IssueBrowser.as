package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1976:String = "open_issues";
      
      private const const_1977:String = "picked_issues";
      ...
      private var var_1804:IIssueBrowserView;
      
      private var var_1805:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1978:
               ...
               {
                  this.var_1806 = new MyIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1806;
            case this.const_1976:
               if(this.var_1804 == null)
               {
                  this.var_1804 = new OpenIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1804;
            case this.const_1977:
               if(this.var_1805 == null)
               {
                  this.var_1805 = new PickedIssuesView(this.issueManager,this,this.var_254.container);
               }
