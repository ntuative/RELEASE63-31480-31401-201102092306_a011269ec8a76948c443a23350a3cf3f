package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_864:Array = [];
      
      private static var var_1638:int = 1000;
      
      private static var var_863:Array = [];
      
      private static var var_1639:int = 200;
      ...
      private var var_1640:IMessageComposer;
      ...
      {
         this.var_699 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_698 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1640);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_864.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_863.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1637[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1320.getValue(param2.chatterName))
            {
               this.var_1320.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1320.getValue(_loc2_);
