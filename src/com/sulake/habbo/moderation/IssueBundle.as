package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_675:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2167 = param2.pickerUserId;
         this.var_2168 = param2.pickerUserName;
         this.var_1311 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1043 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1042;
         }
         if(this.var_675 == null || param1.timeStamp < this.var_675.timeStamp)
         {
            this.var_675 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1043 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1042;
            }
            if(this.var_675 == _loc2_)
            {
               this.var_675 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_675;
         if(_loc2_ == null)
         {
