package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_918:uint = 4284532064;
      
      private static const const_917:uint = 2577770;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1641 = this.createMinimizedWindow();
         }
         if(!this.var_2283)
         {
            return this.var_68;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_918) : uint(const_917);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_918) : uint(const_917);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1110)
            {
            ...
            this.var_397.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_552);
            this.var_397.show();
         }
