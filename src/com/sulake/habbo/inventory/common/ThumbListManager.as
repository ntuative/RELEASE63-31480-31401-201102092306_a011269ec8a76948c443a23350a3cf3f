package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_549 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_549.width;
         this.var_86 = this.var_549.height;
         this.var_1008 = param5;
         this.var_823 = param6;
         this.var_201 = Math.floor(this.var_1008 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1008,this.var_823);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_548 = this.resolveRowCountFromList();
         if(this.var_548 == 0)
         {
            this.var_26 = new BitmapData(this.var_1008,this.var_823);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_201 * this._thumbWidth,this.var_1008),Math.max(this.var_548 * this.var_86,this.var_823),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_548)
         {
            _loc4_ = 0;
      ...
      public function method_12(param1:IThumbListDrawableItem) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         if(param1 == null)
         ...
         if(_loc3_.x == this.var_201 && this.var_26.height < _loc3_.y * this.var_86)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_201 - 1),this.var_86);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_201 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_86),null,null,true);
         _loc4_ = new Rectangle(0,this.var_86,this._thumbWidth * (this.var_201 - 1),this.var_26.height - this.var_86);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_823)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_823);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_549.width,this.var_549.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_549.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_549,this.var_549.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
