package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1172:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_473,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_311));
      }
      ...
      {
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_280));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_334));
      }
      ...
      {
         return PetsModel(this.var_50.getValue(InventoryCategory.const_152));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_50.getValue(InventoryCategory.const_357) as MarketplaceModel;
      }
      ...
      {
         this.var_400 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_473,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_1172 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_473:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_400 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_181)
         {
            return;
         }
         ...
         this.var_50.add(InventoryCategory.const_357,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_400);
         this.var_50.add(InventoryCategory.const_280,_loc3_);
         ...
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_400);
         this.var_50.add(InventoryCategory.const_334,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_311,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_152,_loc8_);
         this.var_185 = true;
         if(this.var_2590)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_311:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_946.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_946.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1980);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_672));
      }
