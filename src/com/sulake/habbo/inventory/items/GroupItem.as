package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_792:int = 0;
      
      protected var var_644:BitmapData;
      ...
      protected var var_2724:BitmapData;
      
      private const const_1952:int = 8947848;
      
      private const const_1953:int = 13421772;
      
      private const const_1673:Number = 1;
      
      private const const_1672:Number = 0.2;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1672;
               _loc1_.blend = this.const_1672;
            }
            else
            {
               this._window.blend = this.const_1673;
               _loc1_.blend = this.const_1673;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1968 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2724;
               _loc5_.visible = true;
            }
            else
            {
