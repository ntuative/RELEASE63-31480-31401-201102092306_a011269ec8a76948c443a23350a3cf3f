package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_965:int = 1;
      
      private const const_1692:int = 2;
      
      private const const_1693:int = 3;
      
      private const const_1703:int = 42;
      
      private const const_1704:int = 120;
      ...
      private var var_743:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_495.add(FurniModel.const_43,new FurniGridView(this.var_65,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_495.add(FurniModel.const_47,new FurniGridView(this.var_65,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_495.getValue(this.var_415);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_415);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_965;
         }
         ...
         if(this.var_2361 == _loc2_)
         {
            return;
         }
         this.var_2361 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_495.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_495.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_495.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_415);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_393)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_743 && this.var_743.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1704)
         {
            _loc3_ = this.const_1704;
         }
         else if(_loc3_ < this.const_1703)
         {
            _loc3_ = this.const_1703;
         }
         else
         {
