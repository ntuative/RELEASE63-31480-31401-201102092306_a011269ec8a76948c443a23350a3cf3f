package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1281:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_206,this.onObjectPlaced);
         this._catalog = param7;
         this.var_591 = new Timer(const_1281,1);
         this.var_591.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_206,this.onObjectPlaced);
               }
            ...
            {
               this.var_591.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_591.stop();
               this.var_591 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_393)
         {
         ...
         if(this.var_898 == null)
         {
            this.var_898 = this._windowManager.buildFromXML(this.var_2383) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_898.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_357);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_475.add(const_43,new Array());
         this.var_475.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_311;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_366 || _loc3_.category == FurniCategory.const_372 || _loc3_.category == FurniCategory.const_393)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1352 && param1.type == RoomEngineObjectEvent.const_206)
         {
            this.var_1352 = false;
         }
      }
      ...
      {
         return this.var_475.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_475.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_475.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_719)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
