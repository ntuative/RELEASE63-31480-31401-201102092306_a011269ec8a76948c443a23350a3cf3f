package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1979:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_945.length)
         {
            if(this.var_945[_loc2_] == param1)
            {
               this.var_945.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_400.getBadgeImage(param1);
