   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_672,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_863,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_181 != null)
            {
               this.var_181.events.removeEventListener(HabboToolbarEvent.const_63,this.onHabboToolbarEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_672,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_863,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1255)
            {
               ...
               this.var_1512 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1512;
            }
         }
         if(this.var_181 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1134,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_879);
         _loc1_.push(RoomWidgetDanceMessage.const_792);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_751);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_755);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_636);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_669);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_878);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_330);
         _loc1_.push(RoomWidgetStopEffectMessage.const_787);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1433);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1118);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1421);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1038);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_606);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_799);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_682);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1594);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_656);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_783);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_653);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_799:
               ...
               break;
            case RoomWidgetWaveMessage.const_879:
            ...
            case RoomWidgetDanceMessage.const_792:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_751:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_755:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_636:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_330:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_993)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_195,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_878:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1001:
                        this._catalog.openCatalogPage(CatalogPageName.const_1606,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1028:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_280);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1568:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1479:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_787:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1060:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1118:
            ...
            case RoomWidgetToolbarMessage.const_854:
               ...
               if(this.var_181)
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_738:
               ...
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_489,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_331:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_423));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_682:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_344,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_656:
            ...
            case RoomWidgetStoreSettingsMessage.const_783:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_344,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_653:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_564));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_390:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_815));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_449:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_506));
         }
      }
