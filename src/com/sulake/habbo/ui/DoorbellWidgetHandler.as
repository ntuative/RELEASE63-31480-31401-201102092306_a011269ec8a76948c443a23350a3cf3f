package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_627];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_627:
      ...
      {
         return [RoomSessionDoorbellEvent.const_111,RoomSessionDoorbellEvent.const_134,RoomSessionDoorbellEvent.const_44];
      }
