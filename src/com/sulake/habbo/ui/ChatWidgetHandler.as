package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_679:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_284 != null)
         {
            ...
            {
               _loc2_ = this.var_284.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_696,RoomWidgetChatSelectAvatarMessage.const_665];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_696:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_243)
                           {
                              _loc13_ = this.var_284.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_395.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_569.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_243:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_569.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_243)
                                    {
                                       this.var_284.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1045 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1045);
            }
            if(this.var_679 == null)
            {
               ...
               this.var_466.y = 0;
               this.var_466.z = 0;
               this.var_679 = _loc4_.getScreenPoint(this.var_466);
               this.var_1045 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_466.x = 0;
            this.var_466.y = 0;
            this.var_466.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_466);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_679.x || _loc8_.y != this.var_679.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_679,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_284)
         {
            _loc2_ = this.var_284.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1044.push(_loc2_);
            }
         }
      }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_569.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1586.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1586.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_284)
            {
               this.var_284.add(_loc3_,param2);
            }
         }
      }
   }
