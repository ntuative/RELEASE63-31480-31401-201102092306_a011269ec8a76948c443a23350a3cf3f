package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_558.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_558.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_853);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_834);
         _loc1_.push(RoomWidgetUserActionMessage.const_729);
         _loc1_.push(RoomWidgetUserActionMessage.const_760);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_318);
         _loc1_.push(RoomWidgetFurniActionMessage.const_679);
         _loc1_.push(RoomWidgetFurniActionMessage.const_715);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_721);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_644);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_662);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1416);
         _loc1_.push(RoomWidgetPetCommandMessage.const_463);
         _loc1_.push(RoomWidgetPetCommandMessage.const_711);
         _loc1_.push(RoomWidgetUserActionMessage.const_502);
         _loc1_.push(RoomWidgetUserActionMessage.const_392);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_771);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_392 || param1.type == RoomWidgetUserActionMessage.const_502 || param1.type == RoomWidgetUserActionMessage.const_559)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_502:
               ...
               break;
            case RoomWidgetUserActionMessage.const_853:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_983,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_741:
               ...
               break;
            case RoomWidgetUserActionMessage.const_834:
            ...
            case RoomWidgetUserActionMessage.const_729:
               ...
               break;
            case RoomWidgetUserActionMessage.const_760:
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_679:
            ...
            case RoomWidgetRoomTagSearchMessage.const_721:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_644:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_662:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_767);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1011);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_984);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_243)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_329)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1004)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_497);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_169)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_248)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc32_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_692);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1574;
                  if(!_loc27_)
                  {
                  ...
                  if(!_loc29_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1047;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1556);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_558.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_558.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_692);
