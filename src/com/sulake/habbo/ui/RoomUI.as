package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1087:IRoomWidgetFactory;
      ...
      private var var_1883:IHabboAvatarEditor = null;
      ...
      private var var_1200:IHabboHelp;
      
      private var var_974:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_602:IHabboSoundManager;
      ...
      private var var_1199:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1457 = RoomDesktop.const_574;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1087.release(new IIDHabboRoomWidget());
            this.var_1087 = null;
         }
         ...
         {
            this.var_602.release(new IIDHabboSoundManager());
            this.var_602 = null;
         }
         ...
         {
            this.var_1200.release(new IIDHabboHelp());
            this.var_1200 = null;
         }
         ...
         if(this.var_1199)
         {
            this.var_1199.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1199 = null;
         }
         this.var_1883 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1087 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1883 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_308.events.addEventListener(AdEvent.const_460,this.adEventHandler);
            this.var_308.events.addEventListener(AdEvent.const_488,this.adEventHandler);
            this.var_308.events.addEventListener(AdEvent.const_430,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1200 = param2 as IHabboHelp;
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_602 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_233,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_304,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_475,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_541,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_728,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_970,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1201,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_731,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_724,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_175,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_633,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_782,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_535,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_159,HabboToolbarIconEnum.ZOOM));
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_159,HabboToolbarIconEnum.MEMENU));
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_159,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_1199 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_761,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_703,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_635,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_320,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_648,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_206,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_442 || param1.type == RoomEngineEvent.const_546)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_761:
               _loc5_ = false;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_284);
               if(this.var_1457 != RoomDesktop.const_574)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_284,this.var_1457);
               }
               if(this.var_308 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_703:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_635:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1087;
         _loc3_.sessionDataManager = this.var_400;
         ...
         _loc3_.avatarEditor = this.var_1883;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_308;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1200;
         _loc3_.moderation = this.var_974;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_602;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1199;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_284);
