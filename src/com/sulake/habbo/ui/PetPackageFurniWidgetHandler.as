package com.sulake.habbo.ui
{
   ...
   public class PetPackageFurniWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IPetDataListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetOpenPetPackageMessage.const_837];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetOpenPetPackageMessage.const_837:
      ...
      {
         return [RoomSessionPetPackageEvent.const_444,RoomSessionPetPackageEvent.const_568];
      }
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPetPackageEvent.const_444:
                  ...
                  this.var_1439 = this.getPetType(this.var_536);
                  _loc4_ = this._container.avatarRenderManager.petDataManager.getPetData(this.var_1439,this);
                  _loc5_ = this.getPetImage(this.var_536);
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_530,this._objectId,_loc5_,-1);
               ...
               case RoomSessionPetPackageEvent.const_568:
                  ...
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_513,this._objectId,null,_loc6_);
                  this._container.events.dispatchEvent(_loc3_);
            }
         }
      }
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_365,this._objectId,_loc2_,-1);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_365,this._objectId,param2,-1);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function petDataReady() : void
      {
         this.petImageReady(this.var_536);
      }
