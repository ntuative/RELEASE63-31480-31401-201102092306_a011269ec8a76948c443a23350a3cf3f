package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1087:IRoomWidgetFactory = null;
      ...
      private var var_1200:IHabboHelp = null;
      ...
      private var var_2348:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_858,this.onRoomContentLoaded);
         }
      }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_191.toolbarSize = this.var_181.size;
            this.var_191.toolbarOrientation = this.var_181.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_473 != null)
         {
            ...
            {
               _loc6_ = this.var_473.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_858,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_717 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_308 != null && this.var_31.state == RoomSessionEvent.const_233)
         {
            this.var_1673 = !this.var_308.showInterstitial();
         }
      ...
      {
         if(this.var_717 == null || this.var_717.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_717.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1087.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(!this.var_473.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_715.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_715.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_716.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_716.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_715.getValue(param1.type);
         if(_loc2_ != null)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_695:
               ...
               if(this.var_974 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  ...
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_329)
                  {
                     this.var_974.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_320:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_749:
               if(!this.var_31.isRoomController && !this.var_400.isAnyRoomController)
               {
                  return;
               }
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_442:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1031,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_701);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_844);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_770);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_645);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2348);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1672) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","IHabboNotifications",_loc3_);
               }
               else
               {
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_473.length)
         {
            _loc2_ = this.var_473.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1673 && this.var_1671)
         {
            this.var_15.startSession(this.var_31);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_278));
         }
      }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_462:
               ...
               this.var_206 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_396,WindowStyle.const_605,WindowParam.const_93) as IToolTipWindow;
               this.var_206.setParamFlag(WindowParam.const_30,false);
