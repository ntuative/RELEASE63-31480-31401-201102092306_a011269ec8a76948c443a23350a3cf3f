package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_887);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_670);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_860);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_887:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_670:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_860:
