package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_122:IHabboMessenger;
      
      private var var_164:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1055:IAvatarRenderManager;
      
      private var var_693:ISessionDataManager;
      
      private var var_2202:FriendListLookAndFeel;
      
      private var var_422:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1615:OpenedToWebPopup;
      ...
      private var var_1616:AvatarSearchResults;
      ...
      {
         this.var_2202 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1616 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_573.stop();
            this.var_573.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_573 = null;
         }
         ...
         if(this.var_122)
         {
            this.var_122.release(new IIDHabboMessenger());
            this.var_122 = null;
         }
         if(this.var_164)
         {
         ...
         if(this.var_1055)
         {
            this.var_1055.release(new IIDAvatarRenderManager());
            this.var_1055 = null;
         }
         if(this.var_881)
         {
         ...
         if(this.var_693)
         {
            this.var_693.release(new IIDSessionDataManager());
            this.var_693 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1615 = new OpenedToWebPopup(this);
         }
         this.var_1615.show(x,y);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1055.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_122 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1055 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_693 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_1197,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_364,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_573)
         {
            this.var_573 = new Timer(120000);
            this.var_573.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_573.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_364);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_422.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_380));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_422.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_422.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1616.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_422.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_693 || !this.var_328)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_693.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_328.vipLimit;
         }
         else if(this.var_693.hasUserRight("fuse_extended_buddylist"))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_150) as IBitmapWrapperWindow;
