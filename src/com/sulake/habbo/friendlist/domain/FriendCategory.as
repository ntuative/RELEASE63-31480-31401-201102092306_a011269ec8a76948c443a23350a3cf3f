package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         if(this.var_887 >= this.getPageCount())
         {
            this.var_887 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_207.length / const_394);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_887 * const_394;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_887 + 1) * const_394,this.var_207.length);
      }
