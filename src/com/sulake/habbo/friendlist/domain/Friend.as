package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1915:int = "F".charCodeAt(0);
      
      public static const const_1745:int = "M".charCodeAt(0);
      ...
      private var var_1122:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1729 = param1.followingAllowed && param1.online;
         this.var_536 = param1.figure;
         this.var_1728 = param1.motto;
         this.var_1730 = param1.lastAccess;
         this.var_1458 = param1.categoryId;
         this.var_1727 = param1.realName;
