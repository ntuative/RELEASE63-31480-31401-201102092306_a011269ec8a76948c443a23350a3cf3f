package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1694:String = "no_reqs_info";
      ...
      private var var_1677:IContainerButtonWindow;
      ...
      {
         this.var_1678 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1677 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1677.procedure = this.onDismissAllButtonClick;
         this.var_1678.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1116)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_355 && _loc4_.state != FriendRequest.const_399)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1678,_loc1_);
         this.setEnabled(this.var_1677,_loc1_);
      }
