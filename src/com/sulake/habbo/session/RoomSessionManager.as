package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1522)
         {
            this.gotoRoom(this.var_2071,this.var_2069,this.var_1521);
            this.var_1522 = false;
            this.var_1521 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1148:
                  break;
               case RoomSessionHandler.const_973:
                  break;
               case RoomSessionHandler.const_712:
