package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         var _loc3_:QuestCampaign = this.var_147[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_147[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_158.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_575 != MODE_TABS)
         {
            this.var_575 = MODE_NO_TABS;
         }
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_147[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_147[param1] = _loc4_;
         }
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1068.addChild(this.var_286.window);
      ...
      private function updateTabs() : void
      {
         ...
         if(this.var_286)
         {
            _loc1_ = this.var_286.code;
         }
         else if(this.var_147.getKeys().length > 0)
         {
            _loc1_ = this.var_147.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_158.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1068 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_147.getKeys())
         {
            _loc3_ = this.var_147[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc2_ = this.var_158.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_561) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_158.getQuestCampaign(param2.caption);
      }
   }
}
