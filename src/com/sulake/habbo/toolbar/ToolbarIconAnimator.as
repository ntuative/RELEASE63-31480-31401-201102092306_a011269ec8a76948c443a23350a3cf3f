package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1350 = param1.loop;
         if(param1.background != null)
         {
            this.var_897 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1350 == true || this.var_894 == 0)
         {
            if(this.var_895.length > 0)
            {
               ++this._frame;
      ...
      {
         return this.var_895.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1350 == false && this.var_894 == 1 && this.var_1611 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_897.width),Math.max(param2.height,this.var_897.height));
            _loc3_.copyPixels(this.var_897,this.var_897.rect,new Point(0,0));
