package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1262:Number = 25;
      
      private static const const_1264:Number = 90;
      
      private static const const_956:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_628 = new Object();
         this.var_629 = new Array();
         this.var_627 = new Array();
         super();
         this._windowManager = param1;
         this.var_1436 = param2;
         this.var_769 = new Timer(const_1262);
         this.var_769.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_361[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_956 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_956 || param1.desktop.height - param1.y < const_1345;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            this.var_361.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_629[this.var_627.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_627[this.var_629.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_254,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_628[_loc3_] == null)
            {
               this.var_628[_loc3_] = new Array();
            }
            if(this.var_628[_loc3_].indexOf(param1) < 0)
            {
               this.var_628[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_361.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_361.splice(this.var_361.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_629.length)
         {
            if(this.var_629[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_628[_loc3_].length)
                  {
                     this.repositionWindow(this.var_628[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_361.length)
         {
            _loc2_ = this._itemList[this.var_361[_loc7_]];
            if(_loc2_.active)
            {
