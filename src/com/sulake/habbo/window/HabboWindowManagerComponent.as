package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_408:uint = 3;
      
      private static const const_1235:uint = 1;
      ...
      private var var_824:IWindowRenderer;
      
      private var var_825:ISkinContainer;
      ...
      private var var_1515:ProfilerOutput;
      
      private var var_1258:ProfilerAgentTask;
      
      private var var_1257:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_825 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_824 = new WindowRenderer(this.var_825);
         this.var_187 = new Array(const_408);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_408)
         {
            this.var_187[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_824,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_187[const_1235];
         ...
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1631,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1515)
            {
               this.var_1515 = new ProfilerOutput(context,this,this.var_824);
            }
            this.var_1515.profiler = _loc3_;
            ...
            this.var_1257 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1257);
            this.var_1010 = true;
         }
      }
      ...
      {
         return this.var_825.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1628,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1643,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1582,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_563,
            "style":WindowStyle.const_186,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
