package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_870:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_621.width,this.var_621.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_621,this.var_621.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_939.width,this.var_939.height,true,0);
            _loc5_ = this.var_939.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_870.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_871.width,this.var_871.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_871,this.var_871.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
