package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1216:IWindowContainer;
      
      public static var var_1471:IWindowContainer;
      
      public static var var_1953:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1156 = [];
         this.var_1405 = [AvatarEditorFigureCategory.const_874,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_240,AvatarEditorFigureCategory.const_826,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1216 == null)
         {
            ...
            var_1216 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1471 == null)
         {
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1405);
         }
         if(param1.length != this.var_1156.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1156.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1156.indexOf(_loc4_.name) < 0)
            {
      ...
      private function method_2() : void
      {
         ...
         var _loc1_:Array = this.var_1405;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1794 == AvatarEditorSideCategory.const_99 || this.var_2546))
         {
         ...
         this.setViewToCategory(this.var_325);
      }
      ...
      {
         if(this.var_1794 == AvatarEditorSideCategory.const_99)
         {
            this.var_2546 = false;
            this.setSideContent(AvatarEditorSideCategory.const_850);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_850:
               break;
            case AvatarEditorSideCategory.const_560:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_560);
               break;
