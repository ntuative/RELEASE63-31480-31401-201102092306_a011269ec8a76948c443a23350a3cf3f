package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1972:String = "hd-99999-99999";
      ...
      private var var_299:PetDataManager;
      
      private var var_749:PaletteManager;
      ...
      private var var_1781:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_575 = RenderMode.const_1396;
         ...
         this.var_97.add(AvatarType.const_114,_loc4_);
         ...
         this.var_299 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_749 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_299.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_299.init();
         this.var_749.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_114) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_806)
         {
            if(this.var_2513 && this.var_2511 && this.var_2512)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1781)
         {
            this.var_1781 = new AvatarFigureContainer(this.const_1972);
         }
         this.var_219.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1781,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_298 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_298.getKeys())
         {
            _loc4_ = this.var_298.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_299.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1512)
         {
            _loc6_ = !this.var_299.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_299.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_298.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_299.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_97.getValue(AvatarType.const_70);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_298.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_298.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_114) as AvatarStructure;
      ...
      {
         return this.var_299 as IPetDataManager;
      }
