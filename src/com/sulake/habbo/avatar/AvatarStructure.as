package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_348:FigureData;
      
      private var var_413:PartSetsData;
      
      private var var_317:AnimationData;
      
      private var var_751:AnimationManager;
      
      private var var_953:ActionDefinition;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_418 = param1;
         this.var_348 = new FigureData();
         this.var_413 = new PartSetsData();
         this.var_317 = new AnimationData();
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_490);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_490);
            return;
         }
         this.var_933 = new AvatarActionManager(param1,this.var_490,param2);
         this.var_953 = this.var_933.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_490);
            return false;
         }
         if(this.var_413.parse(param1))
         {
            if(this.var_490 == AvatarType.const_114)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_490);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_490);
            return false;
         }
         return this.var_348.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_348.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_348.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_348.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_612[param1][param2] = this.var_348.getMandatorySetTypeIds(param1,param2);
         return this.var_612[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_348.getDefaultPartSet(param1,param2);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1384[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_317.getAction(param3.definition);
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_348.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_348.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
