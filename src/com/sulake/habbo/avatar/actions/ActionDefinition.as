package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2536 = parseInt(param1.@precedence);
         this.var_2533 = String(param1.@activepartset);
         this.var_2537 = String(param1.@assetpartdefinition);
         this.var_2535 = String(param1.@lay);
         this.var_742 = String(param1.@geometrytype);
         this.var_2534 = Boolean(parseInt(param1.@main));
         this.var_2530 = Boolean(parseInt(param1.@method_4));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2532 = _loc6_;
            }
            else
            {
               this.var_1789[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1789[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2532;
         }
         return _loc2_;
      }
