package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1966:int = 100;
      
      private const const_1420:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_878 = new Timer(this.const_1966,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_401)
         {
            this.var_401.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_401.addEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_401)
         {
            this.var_401.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_401.removeEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_877);
            if(this.var_1335.indexOf("?") > 0)
            {
               _loc2_ = this.var_1335 + "&retry=" + this.var_877;
            }
            else
            {
               _loc2_ = this.var_1335 + "?retry=" + this.var_877;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1662 = true;
         for each(_loc2_ in this.var_1080)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2334,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1662)
         {
            this.var_1080.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_449[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_449[_loc3_] = _loc6_;
            }
      ...
      {
         var _loc1_:* = null;
         while(this.var_710.length > 0 && this.var_711.length < this.const_1420)
         {
