package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      {
         var _loc1_:* = null;
         while(this.var_449.length > 0)
         {
            _loc1_ = this.var_449.pop() as IPetDataListener;
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.const_269.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1249.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_540.getValue(_loc6_) == null)
               {
                  ...
                  this.var_540.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_449.indexOf(param3) == -1)
                  {
                     this.var_449.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_540.getKeys())
         {
            _loc5_ = this.var_540.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_268.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
