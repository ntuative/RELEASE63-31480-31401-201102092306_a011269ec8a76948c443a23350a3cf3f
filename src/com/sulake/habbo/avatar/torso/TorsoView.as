   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_226,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_166,_windowManager,_assetLibrary);
         ...
         if(var_65 && var_137 == "")
         {
            var_65.switchCategory(FigureData.const_166);
         }
      }
