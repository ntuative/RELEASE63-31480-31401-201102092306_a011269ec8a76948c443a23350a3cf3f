package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_536 && this.var_1246)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_90,this.var_811,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_754));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1246 && this.var_536 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_536 = this._controller.figureData.getFigureString();
               this.var_811 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1493,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_536)
               {
                  this._controller.loadAvatarInEditor(this.var_536,this.var_811,this._controller.clubMemberLevel);
               }
         }
      }
