package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1249:int = 2;
      
      private static const const_1247:String = AvatarSetType.const_34;
      ...
      protected var var_536:AvatarFigureContainer;
      ...
      private var var_953:IActiveActionData;
      ...
      protected var var_1221:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1247,const_1249);
         this.var_309 = new Array();
         this.var_953 = new ActiveActionData(AvatarAction.const_369);
         this.var_953.definition = this._structure.getActionDefinition(const_1248);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_536,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1576;
         if(param2 < AvatarDirectionAngle.const_986)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_568,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_236.length == 1 && this.var_85 == this.var_1969)
         {
            return this.var_85 + this.var_464 + this.var_568 % 4;
         }
         if(this.var_236.length == 2)
         {
            for each(_loc1_ in this.var_236)
            {
               ...
               {
                  return this.var_85 + this.var_464 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_568 % 11;
                  return this.var_85 + "_" + this.var_1969 + this.var_464 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2164 || param2 != this.var_2165 || param1 != this.var_2166)
         {
            this.var_2164 = param3;
            this.var_2165 = param2;
            this.var_2166 = param1;
            this.var_1577 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1221 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1221)
            {
               this.var_43.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_568);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_568);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_309.push(new ActiveActionData(param1,param2,this.var_568));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_269 = this.var_953;
         this.var_269.definition = this.var_953.definition;
         this.resetBodyPartCache(this.var_953);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_236)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_464 = "";
         this.var_236 = this._structure.sortActions(this.var_309);
         if(this.var_236 == null)
         {
         ...
         {
            this.var_752 = this._structure.getCanvasOffsets(this.var_236,this._scale,this.var_85);
            for each(_loc4_ in this.var_236)
            {
               this.var_464 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_271)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1296 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1296 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1294 != this.var_464)
            {
               _loc1_ = true;
               this.var_1294 = this.var_464;
            }
         }
         this.var_1295 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_236)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_849 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1576 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_310 || _loc1_.actionType == AvatarAction.const_263 || _loc1_.actionType == AvatarAction.const_349)
               {
                  this.var_849 = true;
               }
            }
