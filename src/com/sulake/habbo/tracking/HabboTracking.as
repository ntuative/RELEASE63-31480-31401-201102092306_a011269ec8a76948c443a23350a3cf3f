package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_901:uint = 11;
      ...
      private var var_1014:IHabboWindowManager;
      ...
      private var var_551:FramerateTracker = null;
      
      private var var_230:LatencyTracker = null;
      
      private var var_550:LagWarningLogger = null;
      
      private var var_552:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_551 = new FramerateTracker();
         this.var_230 = new LatencyTracker();
         this.var_550 = new LagWarningLogger();
         this.var_552 = new ToolbarClickTracker(this);
         this.var_1265 = new Array(const_901);
         var _loc4_:int = 0;
         while(_loc4_ < const_901)
         {
            this.var_1265[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1611,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1441,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1391,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_622,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1014)
            {
               this.var_1014.release(new IIDHabboWindowManager());
               this.var_1014 = null;
            }
            if(this.var_308)
            {
            ...
            if(this.var_188)
            {
               if(!this.var_188.disposed)
               {
                  ...
                  Component(this.var_188).events.removeEventListener(HabboFriendListTrackingEvent.const_380,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_164)
         {
            if(this.var_230 != null)
            {
               this.var_230.configuration = this.var_164;
            }
            if(this.var_231 != null)
            {
               this.var_231.configuration = this.var_164;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1565);
            if(this.var_164)
            {
               if(this.var_550 != null)
               {
                  this.var_550.configure(this.var_164);
               }
               if(this.var_551 != null)
               {
                  this.var_551.configure(this.var_164);
               }
               if(this.var_552 != null)
               {
                  this.var_552.configure(this.var_164);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_866,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_631,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_443,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_230 != null)
            {
               this.var_230.communication = this._communication;
               this.var_230.connection = param1;
            }
            if(this.var_550 != null)
            {
               this.var_550.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_631)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1404);
         }
         else if(param1.type == HabboHotelViewEvent.const_443)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_866:
               this.trackLoginStep(HabboLoginTrackingStep.const_1432,String(this._communication.port));
               break;
      ...
      {
         this.var_1014 = IHabboWindowManager(param2);
         if(this.var_1014)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_164)
            {
               if(this.var_164.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1265)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1072);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1072,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_188).events.addEventListener(HabboFriendListTrackingEvent.const_380,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_380:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2072)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1401);
            this.var_2072 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_622,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_307,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_308 = param2 as IAdManager;
         this.var_308.events.addEventListener(AdEvent.const_430,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_552)
         {
            this.var_552.track(param1.iconName);
         }
      }
      ...
      {
         this.var_550.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1524;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1524);
         }
         ...
         if(this.var_231 != null)
         {
            this.var_231.update(param1,this.var_453);
         }
         if(this.var_230 != null)
         {
            this.var_230.update(param1,this.var_453);
         }
         if(this.var_551 != null)
         {
            this.var_551.trackUpdate(param1,this,this.var_453);
         }
         if(this.var_550 != null)
         {
            this.var_550.update(this.var_453);
         }
      }
   }
}
