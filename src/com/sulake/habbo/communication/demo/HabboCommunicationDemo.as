package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1667:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_588 = param1;
            this.var_49.initConnection(HabboConnectionType.const_221);
         }
      }
      ...
      {
         if(this.var_49 && this.var_150 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_150.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_150.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_209.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_150.getKey("use.sso.ticket") == "1";
         this.var_588 = this.var_150.getKey("sso.ticket",null);
         this.var_1680 = this.var_150.getKey("flash.client.url","");
         this.var_2372 = this.var_150.getKey("external.variables.txt","");
         if(this.var_209 == null)
         {
            this.var_209 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_49.mode = HabboConnectionType.const_109;
            if(this.var_588)
            {
               this.var_49.initConnection(HabboConnectionType.const_221);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_425,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_49.mode = HabboConnectionType.const_1156;
            }
         }
         this.var_49.initConnection(HabboConnectionType.const_221);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_866);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2373 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_49.mode)
         {
            case HabboConnectionType.const_109:
               ...
               this.var_209.loadBannerImage(_loc7_ + "?token=" + this.var_1345,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1156:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1578:
               this.var_892 = this.generateRandomHexString(30);
               this.var_474 = new DiffieHellman(new BigInteger(this.var_150.getKey("connection.development.prime"),16),new BigInteger(this.var_150.getKey("connection.development.generator"),16));
               this.var_474.init(this.var_892);
               _loc8_ = this.var_474.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_474.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_474.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2373);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1680,this.var_2372));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1667,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_588 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_588);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2374)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1345);
         ...
         this.var_474 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_474.init(_loc14_);
            _loc15_ = this.var_474.getPublicKey(10);
