package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_425:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_143.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_139,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1667,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_143.habboConfiguration.getKey("use.sso","INotify") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1667,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         this.var_120 = new SSOTicket(this.var_143.assets,_loc3_,_loc2_,param1);
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_143.shockwaveClientUrl = this.var_120.shockwaveClientUrl;
         this.var_143.ssoTicket = this.var_120.ticket;
         this.var_120.removeEventListener(SSOTicket.const_397,this.onParsedTicketSuccess);
         this.var_120.removeEventListener(SSOTicket.const_313,this.onParsedTicketFailure);
         this.var_120 = null;
         dispatchEvent(new Event(const_425));
