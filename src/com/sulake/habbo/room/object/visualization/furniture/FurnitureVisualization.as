package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2195:Number = 0.0;
      ...
      private var var_1608:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_630 != spriteCount)
         {
            createSprites(this.var_630);
         }
         var _loc4_:Boolean = false;
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1142:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_969:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_437 != _loc3_.getUpdateID() || param1 != var_183 || param2 != this.var_2725)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2726 = _loc3_.getNumber(RoomObjectVariableEnum.const_249);
            ...
            this.var_1222 = _loc3_.getString(RoomObjectVariableEnum.const_360);
      ...
      {
         if(this.var_2196 != param2 || this.var_2195 != param1)
         {
            this.var_852 = [];
            this.var_851 = [];
            this.var_689 = [];
            ...
            this.var_630 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1607 = this.var_630 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_549.length)
         {
            return "";
         }
         var _loc3_:String = this.var_852[param2];
         var _loc4_:Boolean = this.var_851[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 != this.var_1607)
            {
               _loc6_ = FurnitureVisualizationData.const_549[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_852[param2] = _loc3_;
            this.var_851[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_691[param3] != null && !this.var_1608)
         {
      ...
      {
         if(this.var_688[param2] != null)
         {
            return this.var_688[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_688[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_692[param3] != null)
         {
            return this.var_692[param3];
         }
         if(this._data == null)
         {
