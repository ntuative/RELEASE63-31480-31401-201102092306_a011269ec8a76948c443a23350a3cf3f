package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1635:String = "plane";
      
      public static const const_1603:String = "sphere";
      ...
      private var var_854:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_853 = 0;
         this.var_858 = false;
         this.init(0,0,0,this._direction,this.var_2206,this.var_854,this.var_2207,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1056.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_858 = true;
         if(this.var_853 < this.var_1306)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2209)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_854,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1056.length);
         return this.var_1056[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_853 < this.var_1306)
         {
            if(this.age % this.var_2204 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_853 < this.var_1306)
         {
            ...
            this.y = (2 - this.var_239) * this.y - (1 - this.var_239) * this.lastY + this.var_1617 * this.var_854 * this.var_854;
         ...
         for each(_loc2_ in this.var_329)
         {
            ...
            _loc2_.y = (2 - this.var_239) * _loc2_.y - (1 - this.var_239) * _loc2_.lastY + this.var_1617 * this.var_854 * this.var_854;
