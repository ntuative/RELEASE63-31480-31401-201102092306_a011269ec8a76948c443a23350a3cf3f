package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_938:int = 15;
      
      private static const const_937:int = 31;
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1143[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1143.push(1);
         this.var_1143.push(-1);
         this.var_1142 = new Array();
         this.var_1142.push(const_1313);
         this.var_1142.push(ANIM_SPEED_SLOW);
