package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_317:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_317 = param1 as AnimatedFurnitureVisualizationData;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_841);
                  this.var_1514 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_841);
                     if(_loc4_ > this.var_1514)
                     {
                        this.var_1514 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               ...
               if(this.var_317.hasAnimation(this.var_1009,_loc6_))
               {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_105 != null)
         {
            this.var_105.setLayerCount(this.var_630);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_1009)
         {
            this.var_1009 = param1;
            this.var_630 = this.var_317.getLayerCount(param1);
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_317.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_630 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_982)
                  {
                     _loc10_ = this.var_317.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_317.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_481)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
