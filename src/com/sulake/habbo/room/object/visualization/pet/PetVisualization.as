package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_572:PetVisualizationData = null;
      ...
      private const const_1967:int = 3;
      ...
      private const const_1255:int = 3;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_472.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_472.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_572 = param1 as PetVisualizationData;
         createSprites(this.const_1255);
         var _loc2_:BitmapData = (this.var_572.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this._isSleeping = param1.getNumber(RoomObjectVariableEnum.const_333) > 0;
            this.var_1299 = param1.getString(RoomObjectVariableEnum.const_234);
            this.var_237 = param1.getString(RoomObjectVariableEnum.const_339);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_843);
            this.var_1590 = param1.getNumber(RoomObjectVariableEnum.const_319);
            this.var_1303 = param1.getNumber(RoomObjectVariableEnum.const_613);
            this.var_2133 = param1.getNumber(RoomObjectVariableEnum.const_748);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_178);
            if(this.var_536 != _loc3_)
            {
               this.var_536 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_437 != param1.getUpdateID() || this.var_1660 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1590;
            if(isNaN(this.var_1590))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc5_ != this.var_1592 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_472.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_572.getAvatar(this.var_536,param1,this);
            if(_loc3_ != null)
            {
               this.var_472.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_570 = null;
         _loc2_ = getSprite(this.const_1691);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         var _loc11_:Boolean = this.var_849 || this.var_1083 > 0 || this.var_1667;
         this._experienceData.alpha = 0;
         if(this.var_1303 > 0)
         {
            _loc12_ = param2 - this.var_1303;
            if(_loc12_ < AvatarAction.const_912)
            {
               this._experienceData.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this._experienceData.setExperience(this.var_2133);
               this.var_1083 = this.const_1967;
            }
            else
            {
               this.var_1303 = 0;
            }
            _loc13_ = getSprite(this.const_1679);
            if(_loc13_ != null)
            {
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            _loc13_ = getSprite(this.const_910);
            if(_loc13_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_314,this.var_1299);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1255;
