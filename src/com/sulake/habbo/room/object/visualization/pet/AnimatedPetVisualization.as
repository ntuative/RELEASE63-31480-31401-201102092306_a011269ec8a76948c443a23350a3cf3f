package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_586:int = 1;
      
      private static const const_912:int = 1000;
      
      private static const const_1258:String = "pet_experience_bubble_png";
      
      private static const const_1259:int = 0;
      
      private static const const_1260:int = 1;
      ...
      private var var_317:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_317 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_317.commonAssets != null)
         {
            _loc3_ = this.var_317.commonAssets.getAssetByName(const_1258) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_339);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_234);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_333) > 0;
            this.var_1590 = _loc3_.getNumber(RoomObjectVariableEnum.const_319);
            this.var_1303 = _loc3_.getNumber(RoomObjectVariableEnum.const_613);
            this.var_2133 = _loc3_.getNumber(RoomObjectVariableEnum.const_748);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1597)
            {
               this.var_1597 = _loc6_;
               this.var_2182 = this.var_1597.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1303 > 0)
            {
               _loc2_ = param1 - this.var_1303;
               if(_loc2_ < const_912)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_912 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_237)
         {
            this.var_237 = param1;
            _loc3_ = this.var_317.getAnimationForPosture(var_183,param1);
            this.setAnimationForIndex(const_1259,_loc3_);
         }
         if(param2 != this.var_1299)
         {
            this.var_1299 = param2;
            _loc3_ = this.var_317.getAnimationForGesture(var_183,param2);
            this.setAnimationForIndex(const_1260,_loc3_);
         }
      }
      
      override protected function getAdditionalSpriteCount() : int
      {
         return super.getAdditionalSpriteCount() + const_586;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2182);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_586)
         {
            _loc4_ = _data.getSize(param1);
            if(param2 < _loc3_ - (1 + const_586))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_549.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_549[param2];
               if(_loc4_ == 1)
               {
