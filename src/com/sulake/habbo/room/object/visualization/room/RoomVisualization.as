package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1625:int = 16777215;
      ...
      private static const const_952:int = 10066329;
      
      public static const const_1467:int = 16777215;
      
      public static const const_1649:int = 13421772;
      
      public static const const_1612:int = 10066329;
      ...
      private var var_764:Rectangle = null;
      ...
      private var var_2598:int = 255;
      
      private var var_2599:int = 255;
      
      private var var_2597:int = 255;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_303["null"] = false;
         this.var_303["null"] = true;
         this.var_303["null"] = true;
         this.var_303["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_764 = super.boundingRectangle;
         }
         return new Rectangle(this.var_764.x,this.var_764.y,this.var_764.width,this.var_764.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1007);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1162);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_199,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1625;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_276)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1634)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_121,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_276)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_358.length)
            {
               _loc10_ = this.var_625[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_358[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_96)
               {
                  if(this.var_1837)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2597 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2599 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2598 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1660)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1333 || _loc3_.y != this.var_2323 || _loc3_.z != this.var_2320 || param1.scale != this.var_2322))
            {
               this.var_1333 = _loc3_.x;
               this.var_2323 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2600)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2600 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_637));
            if(_loc4_ != this.var_1173)
            {
               this.var_1173 = _loc4_;
               this.var_2597 = this.var_1173 & 255;
               this.var_2599 = this.var_1173 >> 8 & 255;
               this.var_2598 = this.var_1173 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1102));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_842);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_784);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_629);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_639));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_688));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_608));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_129.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_199 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_303["null"] || param2 != this.var_303["null"] || param3 != this.var_303["null"])
         {
            this.var_303["null"] = param1;
            this.var_303["null"] = param2;
            this.var_303["null"] = param3;
            this.var_358 = [];
            this.var_625 = [];
         }
      }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_199)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_303[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1484;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.const_96 && _loc12_ == RoomPlaneBitmapMaskData.const_236)
                              {
