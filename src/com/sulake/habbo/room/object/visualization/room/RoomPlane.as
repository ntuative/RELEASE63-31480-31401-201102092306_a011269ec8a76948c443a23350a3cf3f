package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1511:Boolean = true;
      ...
      private var var_821:IPlaneRasterizer = null;
      
      private var var_767:PlaneMaskManager = null;
      ...
      private var var_384:PlaneBitmapData = null;
      ...
      private var var_315:Boolean = false;
      
      private var var_66:BitmapData = null;
      
      private var var_200:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2049 = param9;
         this.var_2052 = param10;
         this.var_2051 = param11;
         this.var_2047 = param12;
         this.var_822 = param6;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_821.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_384;
         if(_loc3_ == null)
         {
         ...
         if(this.var_659 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_315))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_288.length * param1.scale;
            ...
            if(this.var_821 != null)
            {
               _loc3_ = this.var_821.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1511,this.var_2049,this.var_2052,this.var_2051,this.var_2047,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1660 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1254.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1254[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1006);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_140.z - originZ,this.var_103.z - originZ,this.var_81.z - originZ,this.var_102.z - originZ);
            if(this._type == const_96)
            {
               relativeDepth += 0.02;
            }
            this.var_2050 = relativeDepth;
            this._isVisible = true;
            this.var_1660 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2048);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_822)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_316.length)
            {
               _loc5_ = this.var_316[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_229.length == this.var_820.length)
         {
            while(_loc1_ < this.var_229.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_820.length)
                  {
                     _loc7_ = this.var_820[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_316.length > this.var_1253.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_822 || this.var_229.length == 0 && this.var_316.length == 0 && !this.var_315 || this.var_767 == null)
         {
            return;
         }
         ...
         if(this.var_315)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_544);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_229.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc3_.leftSideLoc / this.var_289.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc3_.rightSideLoc / this.var_288.length;
                  _loc12_ = _loc3_.type;
                  this.var_767.updateMask(this.var_66,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_820.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_316.length)
            {
               _loc4_ = this.var_316[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc4_.leftSideLoc / this.var_289.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc4_.rightSideLoc / this.var_288.length;
                  _loc13_ = this.var_66.width * _loc4_.leftSideLength / this.var_289.length;
                  _loc14_ = this.var_66.height * _loc4_.rightSideLength / this.var_288.length;
                  this.var_66.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1253.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_315 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_200 != null && (this.var_200.width != param1.width || this.var_200.height != param1.height))
         {
            this.var_200.dispose();
            this.var_200 = null;
         }
         if(this.var_200 == null)
         {
            this.var_200 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_200.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_200.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_200,this.var_200.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
