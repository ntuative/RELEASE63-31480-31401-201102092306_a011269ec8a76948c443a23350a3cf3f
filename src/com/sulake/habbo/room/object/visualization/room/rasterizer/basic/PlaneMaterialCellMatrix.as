package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1500:int = const_361;
      ...
      public static const const_316:int = const_108;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_656 != null)
         {
            this.var_656.assign(new Vector3d());
         }
         this.var_641 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_656,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_641,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1920 == const_108)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_641);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_641,this.var_30.width,this.var_641);
         }
