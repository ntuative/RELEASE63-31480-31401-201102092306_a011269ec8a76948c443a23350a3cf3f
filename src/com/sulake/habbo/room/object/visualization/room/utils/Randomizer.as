package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1757:int = 16777216;
      ...
      private var var_1646:int = 16777216;
      
      private var var_2752:int = 69069;
      ...
      {
         var _loc1_:int = this.var_2752 * this.var_1647 + this.var_2753;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1646;
         this.var_1647 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1646 * param2);
      }
   }
}
