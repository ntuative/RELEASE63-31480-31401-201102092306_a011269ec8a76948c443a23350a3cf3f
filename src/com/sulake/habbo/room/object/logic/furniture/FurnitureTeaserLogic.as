package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_1950:String = "TYPE_INJECTED";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc8_ = object.getId();
               _loc9_ = object.getType();
               _loc10_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_550,_loc8_,_loc9_);
               eventDispatcher.dispatchEvent(_loc10_);
            }
         }
