package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1519:int = 255;
      
      private var var_1263:uint = 16777215;
      
      private var var_1520:int = 255;
      
      private var var_1013:uint = 16777215;
      
      private var var_1518:int = 255;
      
      private var var_1012:int = 0;
      
      private var var_1517:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1007,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_637,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_639,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1012)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1519;
            if(_loc2_ - this.var_1012 >= this.var_1517)
            {
               _loc3_ = this.var_1013;
               _loc4_ = this.var_1518;
               this.var_1012 = 0;
            }
            else
            {
               _loc7_ = this.var_1263 >> 16 & 255;
               _loc8_ = this.var_1263 >> 8 & 255;
               _loc9_ = this.var_1263 & 255;
               _loc10_ = this.var_1013 >> 16 & 255;
               _loc11_ = this.var_1013 >> 8 & 255;
               _loc12_ = this.var_1013 & 255;
               _loc13_ = (_loc2_ - this.var_1012) / this.var_1517;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1520 + (this.var_1518 - this.var_1520) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_637,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_801:
               param2.setString(RoomObjectVariableEnum.const_784,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_699:
               param2.setString(RoomObjectVariableEnum.const_842,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_752:
               param2.setString(RoomObjectVariableEnum.const_629,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_571:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_814:
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_991:
               param2.setNumber(RoomObjectVariableEnum.const_639,_loc3_);
               break;
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1102,int(param1.bgOnly));
         this.var_1263 = this._color;
         this.var_1520 = this.var_1519;
         this.var_1013 = _loc3_;
         this.var_1518 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_458,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1521,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1383,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1390,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_458,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_149 || _loc13_ == RoomPlaneData.const_276)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
