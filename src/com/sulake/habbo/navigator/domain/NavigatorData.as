package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      {
         var _loc2_:int = 0;
         this.var_2642 = param1.limit;
         this.var_1449 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1449 >= this.var_2642;
      }
