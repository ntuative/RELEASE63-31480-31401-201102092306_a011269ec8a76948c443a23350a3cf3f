package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1272:int = 8;
      
      private static const const_1274:int = -16;
      
      private static const const_1273:int = 40;
      ...
      private var var_869:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_869 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2303 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_919 / 2);
         return new Point(param1 * const_919 + _loc3_,param2 * const_1272);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_273,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_36 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_869.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_869.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_869.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1329 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1329,this.var_1329.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_869.getImage(ThumbnailEditorModel.const_33,param2.method_1);
         if(_loc3_ == null)
         {
            Logger.log("Unknown object image id: " + param2.method_1);
            return;
         }
         if(_loc3_.id == 0)
         {
         ...
         if(_loc5_ == null)
         {
            Logger.log("No image for " + param2.method_1);
            return;
         }
         Logger.log("Drawing object: " + param2.pos + ", " + _loc4_);
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1274,_loc4_.y + const_1273 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2303[param1]);
      }
   }
}
