package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2661:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1882 = IButtonWindow(this.find("top_tab"));
         this.var_1881 = IButtonWindow(this.find("obj_tab"));
         this.var_2660 = IWindowContainer(this.find("tile_grid"));
         this.var_2661 = IWindowContainer(this.find("now_editing_container"));
         ...
         Util.setProcDirectly(this.var_1882,this.onTopTabButton);
         Util.setProcDirectly(this.var_1881,this.onObjTabButton);
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc5_.addObj(_loc4_.pos,_loc4_.method_1);
         }
      ...
      {
         this.setEnabled(this.var_1880,this.var_65.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1882,this.var_65.mode != ThumbnailEditorModel.const_57);
         this.setEnabled(this.var_1881,this.var_65.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2661;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2660;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_273,HabboWindowStyle.const_40,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
