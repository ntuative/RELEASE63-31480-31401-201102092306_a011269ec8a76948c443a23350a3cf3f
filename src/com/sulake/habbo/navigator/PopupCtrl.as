package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_342.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_342)
         {
            this.var_342.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_342.reset();
            this.var_342 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_53 == null)
         {
            this.var_53 = IWindowContainer(this._navigator.getXmlWindow(this.var_985));
         ...
         this.var_53.x = _loc2_.x + this.var_2472 + param1.width;
