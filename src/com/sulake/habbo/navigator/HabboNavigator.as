package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_292:MainViewCtrl;
      
      private var var_599:RoomInfoViewCtrl;
      
      private var var_1121:RoomCreateViewCtrl;
      ...
      private var var_2335:RoomThumbnailRenderer;
      
      private var var_925:GuestRoomPasswordInput;
      
      private var var_355:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_292 = new MainViewCtrl(this);
         this.var_599 = new RoomInfoViewCtrl(this);
         this.var_1121 = new RoomCreateViewCtrl(this);
         this.var_2335 = new RoomThumbnailRenderer(this);
         this.var_925 = new GuestRoomPasswordInput(this);
         this.var_355 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_292.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_292.startSearch(Tabs.const_230,Tabs.const_356,param1);
         this.var_292.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_292.startSearch(Tabs.const_286,Tabs.const_228);
         this.var_422.getTab(Tabs.const_286).tabPageDecorator.tabSelected();
      }
