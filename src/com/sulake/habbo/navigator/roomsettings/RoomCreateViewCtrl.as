package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1684 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1684 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_173 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_58 = IItemListWindow(this.var_173.findChildByName("item_list"));
         ...
         var _loc2_:IButtonWindow = this.method_5();
         this.addMouseClickListener(_loc2_,this.onCancelButtonClick);
         var _loc3_:IWindow = this.var_173.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1091 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_173.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_173.desktop,this.var_173.width,this.var_173.height);
         this.var_173.x = _loc4_.x;
         this.var_173.y = _loc4_.y;
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      ...
      {
         return IButtonWindow(this.var_173.findChildByName("create_button"));
      }
      
      private function method_5() : IButtonWindow
      {
         return IButtonWindow(this.var_173.findChildByName("back_button"));
      }
