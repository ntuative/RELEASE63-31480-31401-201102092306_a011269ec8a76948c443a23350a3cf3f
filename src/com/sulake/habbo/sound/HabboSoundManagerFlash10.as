package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_883:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1003,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_882.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_882.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_471;
         _loc2_.play();
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_714.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_714,events);
         _loc8_.volume = this.var_471;
         this.var_883 = null;
         this.var_713 = -1;
         if(_loc5_.length != 0)
         {
      ...
      {
         if(this.var_164 == null || this._connection == null || this._roomEngine == null || this.var_584 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_714.add(_loc3_,_loc6_);
         if(this.var_583.length == 0 && this.var_713 != -1)
         {
            this.var_883.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1003,this.var_713));
            this.var_713 = -1;
            this.var_883 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1400,this.var_713));
         this.var_713 = -1;
         this.var_883 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_471 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_471 * 100)));
         }
      }
      ...
      {
         this.var_471 = param1;
         this.var_584.updateVolume(this.var_471);
