package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1251:uint = 88200;
      
      private static const const_1252:uint = 88200;
      ...
      private var var_1579:uint;
      
      public function TraxSequencer(param1:int, param2:TraxData, param3:Map, param4:IEventDispatcher)
      {
         this.var_1579 = uint(const_270 / 44.1);
         super();
         this._events = param4;
         this.var_2170 = param1;
         this.var_471 = 1;
         this.var_1297 = new Sound();
      ...
      public function play() : Boolean
      {
         ...
         this.var_1298 = false;
         this.var_1297.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1297.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1297.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      {
         return Math.ceil(param1 / const_1251);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc1_ < this.var_1578.channels.length)
         {
            ...
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1581.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_678.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_678[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_678[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_678[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_678[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         this.var_204 += const_270;
         if(this._soundChannel != null)
         {
            this.var_1579 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_204 > this._length + this.var_1579 * 44.1)
         {
            this.var_1298 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_886,this.var_2170));
      }
   }
}
