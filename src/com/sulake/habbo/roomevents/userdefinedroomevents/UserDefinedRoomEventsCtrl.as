package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1846:TriggerConfs;
      
      private var var_1847:ActionTypes;
      
      private var var_1848:ConditionTypes;
      
      private var var_261:Dictionary;
      
      private var var_60:Triggerable;
      
      private var var_766:RoomObjectHightLighter;
      ...
      {
         this.var_1846 = new TriggerConfs();
         this.var_1847 = new ActionTypes();
         this.var_1848 = new ConditionTypes();
         this.var_261 = new Dictionary();
         super();
         this.var_89 = param1;
         this.var_766 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1177 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_90,"delay_slider_container")),this.var_89.assets,0,20,1);
         this.var_1177.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1177.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_766.hideAll(this.var_261);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_766.showAll(this.var_261);
         if(this.var_60 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_60);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1177.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1177.getValue()) : 0;
      }
