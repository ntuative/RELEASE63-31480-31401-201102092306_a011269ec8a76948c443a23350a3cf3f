package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1507:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1509 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_654)
         {
            this.var_654 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_654)
            {
               return;
            }
            this._window.content.addChild(this.var_654);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_655)
         {
            this.var_655 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_655)
            {
               return;
            }
            this._window.content.addChild(this.var_655);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_655.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_450;
         }
         this.showView(this.var_655);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_450);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_980 || param1 == ChangeUserNameResultMessageEvent.var_981)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_450 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_450 != _loc5_)
               {
                  this.var_1508 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_450);
               break;
