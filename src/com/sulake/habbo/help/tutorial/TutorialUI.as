package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_345:String = "TUI_NAME_VIEW";
      
      public static const const_404:String = "TUI_CLOTHES_VIEW";
      
      public static const const_456:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         this.var_34 = param1;
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_555,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_423,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_564,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_290,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1154 && this.var_1153 && this.var_1401;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_555,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_423,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_564,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_290,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_42 == null || this.var_42.id == const_91)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_555:
               this.var_1401 = true;
               if(this.var_42 != null && this.var_42.id == const_456)
               {
                  this.showView(const_91);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2135 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2136;
         this._window.width = _loc2_.width + this.var_2135;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_42 != null && (this.var_42.id == const_345 || this.var_42.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      {
         this.var_1154 = true;
         if(this.var_42 != null && (this.var_42.id == const_404 || this.var_42.id == const_91))
         {
            this.showView(const_91);
         }
      }
