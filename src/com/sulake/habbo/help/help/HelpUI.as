package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_325 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102092301));
         this.var_181 = param5;
         this.var_106 = new Map();
         this.var_106.add(HabboHelpViewEnum.const_1463,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_182,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_522,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_305,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_260,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_363,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_838,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_238,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_106.add(HabboHelpViewEnum.const_1166,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_106.add(HabboHelpViewEnum.const_1075,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_720,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_460.length == 0 || param1 != this.var_325)
            {
               this.var_460.push(this.var_325);
            }
         }
         this.var_325 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_325);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_238:
               ...
               break;
            case CallForHelpResultEnum.const_1067:
               this.showUI(HabboHelpViewEnum.const_1075);
               break;
            case CallForHelpResultEnum.const_1100:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_106.getValue(HabboHelpViewEnum.const_182) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_555));
      }
      ...
      {
         return this.var_106.getValue(this.var_325);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2135 = this._window.width - _loc4_.width;
         this.var_2136 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2136;
         this._window.width = _loc1_.width + this.var_2135;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_460.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_325 == HabboHelpViewEnum.const_182)
         {
            return;
         }
         if(this.var_563.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_563.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_563.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_326.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_563[1],this.var_563[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_563[0],this.var_563[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_325 == HabboHelpViewEnum.const_182 || this.var_460.length == 0)
         {
            return;
         }
         if(this.var_326 == null)
         {
            ...
            this.var_326 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_326.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_326.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_326 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_326 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_326 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
