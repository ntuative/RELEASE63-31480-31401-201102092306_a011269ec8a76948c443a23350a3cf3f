package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_925:int = 0;
      
      private static const const_412:int = 1;
      
      private static const const_924:int = 2;
      ...
      {
         return this.var_589 != const_925;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1683 != RecyclerStatusMessageEvent.const_1085;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_589 == const_412;
      }
      ...
      {
         this.var_589 = const_924;
         this.var_113 = new Array(const_191);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1683)
         {
            case RecyclerStatusMessageEvent.const_1600:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1085:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1013:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1474:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_191)
         {
            return false;
         }
         var _loc1_:int = 0;
