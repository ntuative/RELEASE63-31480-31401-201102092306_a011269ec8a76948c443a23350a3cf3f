package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1270:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1323:XML;
      
      private static var var_1324:XML;
      ...
      private var var_2751:IWindowContainer;
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1410;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1461;
            }
         }
      }
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1324) as IItemListWindow;
         if(this.var_58 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1323) as IWindowContainer;
         }
         else
         {
