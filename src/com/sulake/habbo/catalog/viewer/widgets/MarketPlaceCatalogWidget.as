package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1671:int = 1;
      
      private const const_1670:int = 2;
      
      private const const_1970:int = 40;
      
      private const const_1971:int = 10;
      
      private var var_738:Array;
      
      private var var_1386:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1670,_loc2_.length);
         if(!this.var_486)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1131 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1131));
            ++this.var_1131;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1671);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1386.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
