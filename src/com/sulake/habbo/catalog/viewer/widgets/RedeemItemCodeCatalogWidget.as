package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_802:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_803.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_803 = null;
         }
         if(this.var_802 != null)
         {
            this.var_802.removeEventListener(WindowKeyboardEvent.const_172,this.windowKeyEventProcessor);
            this.var_802 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_803 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_803 != null)
         {
            this.var_803.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_802 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_802 != null)
         {
            this.var_802.addEventListener(WindowKeyboardEvent.const_172,this.windowKeyEventProcessor);
         }
         return true;
      }
