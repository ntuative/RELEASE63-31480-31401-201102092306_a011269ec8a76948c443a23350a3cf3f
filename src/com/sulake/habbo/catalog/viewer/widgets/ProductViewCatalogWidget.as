package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1542:Point;
      
      private var var_455:IItemGridWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_832 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1026 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1542 = new Point(this.var_82.x,this.var_82.y);
         this.var_455 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1277 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1543 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_455 != null)
         {
            ...
            this.var_455.destroyGridItems();
         }
         if(this.var_1277 != null)
         {
            this.var_1277.visible = false;
         }
         ...
         this.var_832.text = _loc4_;
         this.var_1026.text = _loc5_;
         this.var_832.height = this.var_832.textHeight + 5;
         this.var_1026.y = this.var_832.y + this.var_832.height;
         this.var_1026.height = Math.max(130,this.var_1026.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_450:
                  _loc6_ = this.var_1543.clone();
                  if(this.var_455 != null)
                  {
                     this.var_455.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_455,this.var_1277,this.var_1877);
                     this.var_455.scrollV = 0;
                  }
                  break;
               case Offer.const_540:
               case Offer.const_483:
                     ...
                     case ProductTypeEnum.const_255:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_314,AvatarAction.const_433);
                              _loc16_.appendAction(AvatarAction.const_271,_loc8_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1542.x;
            this.var_82.y = this.var_1542.y;
            if(param3 != null)
            {
