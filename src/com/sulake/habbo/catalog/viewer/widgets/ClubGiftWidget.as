package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this._controller.purse.method_3 >= this.const_197 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this._controller.purse.method_3 % this.const_197;
            _loc4_ = this._controller.purse.method_3 / this.const_197;
            this._controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this._controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(param2.isVip)
         {
            _loc6_ = param2.daysRequired - this._controller.purse.method_3;
         }
         else
         {
            _loc6_ = param2.daysRequired - (this._controller.purse.pastClubDays + this._controller.purse.method_3);
         }
