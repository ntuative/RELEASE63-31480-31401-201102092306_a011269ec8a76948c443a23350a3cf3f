package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1660:String = "ctlg_";
      ...
      private var var_1193:ICatalogViewer;
      ...
      private var var_1110:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1109);
      }
      ...
      {
         var _loc2_:String = const_1660 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1511:
               if(this.var_1110 == null)
               {
                  this.var_1110 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1110);
               }
               break;
            case CatalogWidgetEnum.const_1544:
               this.var_47.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1359:
            ...
            case CatalogWidgetEnum.const_1560:
               ...
               break;
            case CatalogWidgetEnum.const_1372:
            ...
            case CatalogWidgetEnum.const_1532:
               ...
               break;
            case CatalogWidgetEnum.const_1440:
