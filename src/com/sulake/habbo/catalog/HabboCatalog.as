package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_294:ChargeConfirmationDialog;
      ...
      private var var_2469:GiftWrappingConfiguration;
      
      private var var_1124:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_216.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_164.getKey("client.credits.embed.enabled","INotify") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_400.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_400.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = this.var_400.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_735.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_96.getActivityPointsForType(Purse.const_173)));
         var _loc1_:int = 0;
      ...
      {
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_694)
         {
            if(!this.var_400.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_293.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_293 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_293.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1743 = param1.session.isPrivateRoom;
               if(this.var_87 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1124 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_734 && this.var_734 != "")
         {
            this.var_341.openPage(this.var_734);
            this.var_734 = "";
            this.var_922 = -1;
         }
         else if(this.var_922 > -1)
         {
            this.var_341.openPageById(this.var_922,this.var_1742);
            this.var_922 = -1;
            this.var_1742 = -1;
            this.var_734 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_293.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_293.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2468 && this.var_602 != null)
         {
            this.var_602.playSound(HabboSoundTypesEnum.const_1069);
         }
         this.var_2468 = false;
         if(this.var_294 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_64,this.var_96.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2470 && this.var_602 != null)
         {
            this.var_602.playSound(HabboSoundTypesEnum.const_1209);
         }
         this.var_2470 = false;
         if(this.var_294 != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_96.method_3 = _loc2_.method_3;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1124.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_293.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2469 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_294 == null)
         {
            this.var_294 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_294.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_735.remove(_loc2_.petType);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_735.add(_loc2_.petType,_loc3_.slice());
            this.var_293.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.petType,_loc3_.slice()));
         }
      }
