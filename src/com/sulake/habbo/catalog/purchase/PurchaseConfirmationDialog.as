package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1706:uint = 4.293848814E9;
      
      private const const_1707:uint = 4.294967295E9;
      
      private const const_1947:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1527 = _loc1_.stuffTypes;
            this.var_664 = _loc1_.boxTypes;
            this.var_663 = _loc1_.ribbonTypes;
            this.var_1017 = this.var_1527[0];
            this.var_320 = this.var_664[0];
            this.var_319 = this.var_663[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_319 < 0)
         {
            this.var_319 = this.var_663.length - 1;
         }
         if(this.var_319 > this.var_663.length - 1)
         {
            this.var_319 = 0;
         }
         if(this.var_320 < 0)
         {
            this.var_320 = this.var_664.length - 1;
         }
         if(this.var_320 > this.var_664.length - 1)
         {
            this.var_320 = 0;
         }
         var _loc1_:int = this.var_664[this.var_320] * 1000 + this.var_663[this.var_319];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_88.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1017,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1268 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1527;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1017);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_664[this.var_320]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_663[this.var_319]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_88,this.var_1267,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_88.offerId,this.var_1267);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_207)
               {
                  ...
                  if(_loc5_.length >= this.const_1946)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2083 = _loc3_.text;
               break;
            ...
            case WindowKeyboardEvent.const_328:
               ...
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_321 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_321 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_321) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_232 == null || this.var_553 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_321) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_321);
         }
         this.var_321 = param1;
         if(this.var_321 < 0)
         {
            this.var_321 = _loc2_.numListItems - 1;
         }
         if(this.var_321 >= _loc2_.numListItems)
         {
            this.var_321 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_321) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1947;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1706) : uint(this.const_1707);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1017;
               }
            }
            _loc4_++;
         }
